...
# Update and Upgrade
###########################
echo "$(date +'%b %d %T'): starting install" >> /home/ubuntu/elk-vr-install.log
apt-get update -y && apt-get upgrade -y

###########################
# Elasticsearch
###########################
echo "$(date +'%b %d %T'): installing  Elasticsearch" >> /home/ubuntu/elk-vr-install.log
...
# Kibana
###########################
echo "$(date +'%b %d %T'): installing Kibana" >> /home/ubuntu/elk-vr-install.log
...
# Filebeat
###########################
echo "$(date +'%b %d %T'): installing Filebeat" >> /home/ubuntu/elk-vr-install.log
apt-get update && apt-get install filebeat

###########################
# Velociraptor
###########################
echo "$(date +'%b %d %T'): installing Velociraptor" >> /home/ubuntu/elk-vr-install.log
cd /opt
...
echo "$(date +'%b %d %T'): instalation complete: your server is now ready for use" >> /home/ubuntu/elk-vr-install.log
